      ...
      <div 
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-medium leading-snug text-slate-600 dark:text-slate-400">{item.locationName}</p>
    ...
    <div 
      ...
      <div className="flex items-start gap-3 relative z-10">
        <div className="mt-1.5 relative">
          <div className="h-2.5 w-2.5 rounded-full bg-slate-400 group-hover:bg-primary transition-colors duration-300 shadow-[0_0_8px_rgba(0,0,0,0.1)]"></div>
        ...
        <div>
          ...
          <p className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug group-hover:text-secondary dark:group-hover:text-primary transition-colors">
            {item.locationName}
          </p>
